...
The .ico is committed, so this is not part of running the app: cairosvg pulls native cairo
libs and there is no reason to carry them to regenerate a file that never changes.
